...
export const ROOT_URL = 'http://192.168.0.114:8070';
...
// User
export const USER_LOGIN_API_URL = `${API_URL}/users/login`;
export const USER_PROFILE_API_URL = `${API_URL_SECURE}/users/profile`;
export const USER_UPDATE_API_URL = `${API_URL}/users/update`;
export const USER_FORGOT_PASSWORD_API_URL = `${API_URL}/users/password/reset`;
