...
import IconBadge from '../shared/badges/IconBadge';
import CommentCard from '../ui/cards/CommentCard';
import Heading from '../ui/headings/Heading';
import FadeText from '../shared/typography/FadeTexts';
      ...
      <section className="myContainer">
        <div className="content grid grid-cols-3 gap-[7.44rem] lg:gap-16">
          <div className="description flex flex-col gap-4 col-span-2">
            ...
            <Typography.SubHeading>BCS Exam Prep 2023 Edition</Typography.SubHeading>
              ...
              <table className="">
                <tr className="flex">
                  ...
                  <td className="flex flex-col justify-start">
                    ...
                    <Typography.Text rest={'text-base'}>Cristofer Jonas</Typography.Text>
                  </td>

                  <td className="flex flex-col justify-start ms-10">
                    <FadeText className="text-[0.875rem]">Last Updated</FadeText>
                    <Typography.Text rest={'text-base'}>28 January, 2022</Typography.Text>
                  </td>
                  <td className="flex flex-col justify-start ms-10">
                  ...
                  <td className="mt-auto pb-2 px-2">
                    <Typography.Text rest={`text-[0.875rem]`}>4(2)</Typography.Text>
                  </td>
                </tr>
              </table>
            </div>
            ...
            <div className="overview_section hidden">
              <div className="overview mt-6 flex flex-col gap-4 mb-16">
                <Heading text="Overview" style={`text-[1.5rem] font-lite_blue`}></Heading>

                <Paragraph>
                  Elevate your BCS exam preparation with our online model tests. Immerse yourself in
                  a comprehensive and dynamic study experience tailored specifically for BCS
                  examinations.
                  <br /> <br /> Access realistic simulations, a rich question bank, and instant
                  performance analysis to ensure you are ready to conquer the BCS exam with
                  confidence. Sharpen your skills, track your progress, and embrace success with our
                  dedicated BCS exam preparation platform.
                </Paragraph>
                <Heading
                  text="What’s included inside the bundle?"
                  style={`text-[1.5rem] font-lite_blue mt-6`}
                ></Heading>
                <ul className="list-none">
                  <li className="flex gap-3 pb-3">
                    <div className="icon">
                      ...
                      >
                        <path
                          d="M10.875 8.625L14.625 12L10.875 15.375"
                          stroke="#474D66"
                          strokeWidth="2"
                          strokeLinecap="round"
                    ...
                    <div className="text ">
                      <Paragraph>
                        <Heading
                          ...
                          style={`text-base`}
                        ></Heading>
                        Gain insights into the specific subjects and topics that constitute the BCS
                        exam, ensuring focused preparation.
                      </Paragraph>
                    </div>
                  </li>
                  ...
                  <li className="flex gap-3 pb-3">
                    ...
                    <div className="text ">
                      <Paragraph>
                        <Heading text={`Detailed Question Types: `} style={`text-base`}></Heading>
                        Understand the various question formats that may appear on the exam,
                        allowing you to tailor your study approach accordingly.
                      </Paragraph>
                    </div>
                  </li>
                  ...
                  <li className="flex gap-3 pb-3">
                    ...
                    <div className="text ">
                      <Paragraph>
                        <Heading
                          text={`Critical Exam Areas Highlighted: `}
                          style={`text-base`}
                        ></Heading>
                        Identify key areas and concepts that are crucial for success, providing a
                        roadmap for targeted and efficient preparation.
                      </Paragraph>
                    </div>
                  </li>
                  ...
                  <li className="flex gap-3 pb-3">
                    ...
                    <div className="text ">
                      <Paragraph>
                        <Heading
                          text={`Strategic Insights for Success: `}
                          style={`text-base`}
                        ></Heading>
                        Uncover strategies and tips to navigate the BCS exam effectively, ensuring
              ...
              <div className="bundel-content flex flex-col gap-6 ">
                <Heading text={`Bundel Content`} style={`text-3xl`}></Heading>
                  ...
                  <div className="collapse collapse-arrow rounded-none">
                    ...
                    <div className="collapse-content p-4 border-solid border border-lite_green border-t-0 flex justify-between">
                      ...
                      <div className="playButton flex gap-[0.38rem] items-center">
                        ...
                        <div className="small_semibold text-deep_green font-bold">Start Test</div>
                      </div>
                    </div>
                  </div>
                  <div className="collapse collapse-arrow rounded-none">
                  ...
                  <div className="reviews mt-2 p-6 flex justify-between">
                    ...
                    <div className="rating_progress flex flex-col gap-2 mt-4">
                      <div className="flex justify-between">
                        ...
                        <div className="count ml-8 small_semibold">2 rating</div>
                      </div>
                      ...
                      <div className="flex justify-between">
                        ...
                        <div className="count ml-8 small_semibold">0 rating</div>
                      </div>
          ...
          <div className="details col-span-1 flex p-4 gap-4 flex-col">
            ...
            <div className="price flex gap-4 items-center">
              ...
              {/* Actual Price */}
              <FadeText className={`text-3xl line-through decoration-gray-500`}>$300</FadeText>
            </div>
            ...
            <div className="cart_button w-full">
              <button className="w-full bg-title_green px-[24px] py-[8px] rounded h-[3rem] font-600 text-16p text-white tracking-[0.5px]">
                <img
                  src={assets.ShopingCart}
                  alt="Cart"
                  className="w-4 h-4 object-cover inline mr-2"
                />

                <span className="inline">Add to Cart</span>
              </button>
            </div>
            <div className="semi_lerge_bold text-filter_green">BCS Exam Prep 2023 Edition</div>

            <div className="courseDetails mt-2">
              <div className="flex justify-between border py-4 px-2">
                <IconBadge img={assets.UserSVG} title="Examiner"></IconBadge>
              ...
              <div className="flex justify-between border border-t-0 py-4 px-2">
                <IconBadge img={assets.RefreshSVG} title="Last Updated"></IconBadge>

                <span className="base_bold text-filter_green ">28 January, 2022</span>
              </div>

              <div className="flex justify-between border border-t-0 py-4 px-2">
                <IconBadge img={assets.TimeSVG} title="Duration"></IconBadge>

                <span className="base_bold text-filter_green ">20:12:51 Hrs</span>
              </div>

              <div className="flex justify-between border border-t-0 py-4 px-2">
                <IconBadge img={assets.StudentSVG} title="Enroll"></IconBadge>

                <span className="base_bold text-filter_green ">400</span>
              </div>

              <div className="flex justify-between border border-t-0 py-4 px-2">
                <IconBadge img={assets.StarSVG} title="Review"></IconBadge>
            ...
            <div className="tag mt-4 flex flex-col gap-4">
              <div className="base_bold font-600">Tags</div>

              <div className="badges flex gap-4">
                <CategoryBadge className="text-lite_blue bg-fade_white px-3 py-1">
                  BCS
                </CategoryBadge>
                <CategoryBadge className="text-lite_blue bg-fade_white px-3 py-1">
                  Bank Job
