...
const AddCart = () => {
  return (
    <div className="w-[356px] p-4 shadow-lg">
      <div className="h-[188px] border">imag</div>
      <Typography.SubHeading className="text-[32px] font-bold">$246.00</Typography.SubHeading>
      ...
      <div>
        ...
        <div className="flex justify-between items-center gap-2">
          ...
          <Typography.Text className="font-semibold text-primary">28 January, 2022</Typography.Text>
        </div>
        <div className="flex justify-between items-center gap-2">
          <Typography.Text className="">Duration</Typography.Text>
          <Typography.Text className="font-semibold text-primary">20:12:51 Hrs</Typography.Text>
        </div>
        <div className="flex justify-between items-center gap-2">
          <Typography.Text className="">Enroll</Typography.Text>
          <Typography.Text className="font-semibold text-primary">258,00,00</Typography.Text>
        </div>
        <div className="flex justify-between items-center gap-2">
